...
import { COLORS, FONTS, FONT_SIZE, SPACING, RADIUS, SHADOW } from "@/constants/theme";
...
export default function Profile() {
    ...
    function handleLogout() {
        Alert.alert("Sair da conta", "Tem deseja que deseja encerrar sua sessão?", [
    ...
    function handleExcluirConta() {
        Alert.alert(
            "Excluir conta",
            "Essa ação é mermanente e remove todos os seus dados, deseja continuar?",
            [
                { text: "Cancelar", style: "cancel" },
                {
                    text: "Excluir conta",
        ...
        <SafeAreaView style={styles.safe} edges={["top"]}>
            <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.avatarSection}>
                    {user?.fotoPerfil ? (
                        <Image source={{ uri: user.fotoPerfil }} style={styles.avatar} contentFit="cover" />
                    ) : (
                ...
                <Card style={styles.infoCard}>
                    {editando ? (
                        <>
                            <AppInput label="Nome de exibição" value={nome} onChangeText={setNome} icon="person-outline" />
                            <View style={styles.editActions}>
                                ...
                                <View style={{ flex: 1 }}>
                                    <AppButton title="Salvar" variant="primary" onPress={handleSalvar} loading={salvando} />
                                </View>
                            </View>
                        </>
                    ) : (
                        <>
                            ...
                            <View style={styles.editBtnArea}>
                                <AppButton title="Editar perfil" variant="outline" onPress={() => setEditando(true)} />
                            </View>
                        </>
                    )}
                </Card>
