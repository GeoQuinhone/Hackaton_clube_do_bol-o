...
import { COLORS, FONTS, FONT_SIZE, SPACING, RADIUS, GRADIENTS, SHADOW } from "@/constants/theme";
    ...
    return (
        <SafeAreaView style={styles.safe} edges={["top"]}>
            ...
            {minhaPosicao && (
                ...
                >
                    ...
                    <View style={styles.myPointsRow}>
                        ...
                        <Text style={styles.myPoints}>{minhaPosicao.pontuacaoTotal} pts</Text>
                    </View>
                </LinearGradient>
            )}
            ...
            {isLoading ? (
                ...
                <ErrorState subtitle="Não conseguimos carregar o ranking." onRetry={refetch} />
                        ...
                        data && data.totalPages > 1 ? (
                            <View style={styles.pagination}>
                                ...
                                <Text
                                    ...
                                    onPress={() => page < data.totalPages - 1 && setPage(page + 1)}
                                >
                                    Próxima →
                                </Text>
                            </View>
